...
import static com.harryabad.chess.engine.board.Board.*;

public abstract class Move {

    protected final Board board; //keep track of board we move on
    protected final Piece movedPiece; //keep track of piece we want to move
    protected final int destinationCoordinate; // keep track of piece destination
    ...
    public Board execute() {
        //will return a new board. does not mutate existing board we have

        final Builder builder = new Builder(); //materialise a new board to return from execute

        for (final Piece piece : this.board.currentPlayer().getActivePieces()) { //traverse through all pieces of current player
            if (!this.movedPiece.equals(piece)) { //for all pieces that AREN'T the moved piece, just place onto a new board
        ...
        builder.setPiece(this.movedPiece.movePiece(this)); //set the piece for the moved piece
        //set the movemaker for the outgoing board to the opponent turn
    ...
    public static class AttackMove extends Move {
        ...
        final Piece attackedPiece; // piece that's being attacked
    ...
    public static abstract class CastleMove extends Move {
        ...
        public Board execute(){
            ...
            builder.setPiece(this.movedPiece.movePiece(this)); // moving king to its destination location
            //TODO look into first move of normal pieces
            builder.setPiece(new Rook(this.castleRook.getPieceAlliance(), this.castleRookDestination)); //create new rook on new tile
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            return builder.build();
        }
    ...
    public static class MoveFactory {
        ...
        //Given a board and a from and to coordinate
        public static Move createMove(final Board board, final int currentCoordinate, final int destinationCoordinate) {

            //get that move that's available on the board
